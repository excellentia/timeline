...
<%-- Common values declaration--%>
<c:set var="detailIconPath" value="./pages/inc/icons/details.png" />
<c:set var="deleteIconPath" value="./pages/inc/icons/delete.png" />
<c:set var="editIconPath" value="./pages/inc/icons/edit.png" />
